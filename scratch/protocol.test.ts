...
const string1 =
  '{"version":1,"op":{"type":"delete","id":{"clientId":"A","clock":1}}}';
const string2 =
  '{"version":2,"op":{"type":"delete","id":{"clientId":"A","clock":1}}}';
const string3 =
  '{"version":1,"op":{"type":"insrt","id":{"clientId":"A","clock":1}}}';
const string4 = '{"version":1,"op":null}';
const string5 = '{"vers';
const string6 =
  '{"version":1,"op":{"type":"insert","originId":{"clientId":"","clock":0},"value":"a","id":{"clientId":"A","clock":1}}}';
...
if (message1 !== null) {
  ...
  console.log(
    reSerialize === string6 ? "Serialize working" : "Serialize not working",
  );
}
...
const string7 =
  '{"version":1,"op":{"type":"insert","originId":{"clientId":"","clock":0},"value":"a","id":{"clientId":"A","clock":1}}}';
const string8 =
  '{"op":{"id":{"clock":1,"clientId":"A"},"value":"a","type":"insert","originId":{"clock":0,"clientId":""}},"version":1}';
...
console.log(
  protocol.serialize(fromEight!) === string7
